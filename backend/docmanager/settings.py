...
SECRET_KEY = 'django-insecure-!^50+fo*)7xftgg+78vn4z8x(l)@8_*gh+fx!0jv###a*@)t1^'
...
# Adding CORS configuration for preflight requests
CORS_PREFLIGHT_MAX_AGE = 86400  # 24 hours

# Expose headers needed for authentication
CORS_EXPOSE_HEADERS = [
    'Authorization',
    'Content-Type',
]
